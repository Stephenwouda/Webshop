<?php 
    ...
    $sql = "SELECT naam, prijs, afb, voorraad FROM product WHERE catid = 1";
    ...
    <section class="bg-dark text-light p-5 text-center">
        <div class="container">
            <div class="d-sm-flex justify-content-center">
                <div>
                    <h1><span class="text-danger">Everything</span> u need to build <span class="text-danger">the best</span> PC's!</h1>
                    <p class="lead my-4">We sell the best computer parts for your new build or to renew your pc! <br>Shipping to every country in the world and fast delivery's! </p>
                </div>
            </div>
        </div>
    </section>
